...
import com.example.dao.PlaceRepository;
import com.example.dao.ProjectionRepository;
...
public class CinemaInitServiceImpl implements  IcinemaInitService {
	...
	public void initVilles() {
		Stream.of("Dakar","Pikine","Guediawaye","Rufisque").forEach(nameVille->{
	...
	public void initCinemas() {
      villeRepository.findAll().forEach(v->{
    	  Stream.of("CinemaDakar","cinemaPikine","cinemaGuediawaye","cinemaRufisque").forEach(nameCinema->{
	...
	public void initSalles() {
	      cinemaRepository.findAll().forEach(cinema->{
	    	  for (int i = 0; i < cinema.getNombreSalles(); i++) {
				...
				salle.setNombreSalles(15+(int)(Math.random()*10));
	...
	public void initPlaces() {
		 salleRepository.findAll().forEach(salle->{
	    	  for (int i = 0; i < salle.getNombreSalles(); i++) {
	...
	public void initCategories() {
   		Stream.of("Drame","Histoire","Comedie","Fiction","Action").forEach(cat->{
	...
	public void initfilms() {
		...
		List<Categorie> categories = categorieRepository.findAll();
   		Stream.of("How High","Game of thrones","Dictator","Norbit","Chucky").forEach(f->{
   			Film film = new Film();
   			film.setTitre(f);
